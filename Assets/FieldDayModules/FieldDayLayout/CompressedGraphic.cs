...
namespace FieldDay.Layout {
    ...
    public struct CompressedStreamingUGUITexture {
        ...
        static public void Compress(CompressedPackageBuilder compressor, StreamingUGUITexture texture, out CompressedStreamingUGUITexture data) {
        ...
        static public void Decompress(CompressedPackageBank bank, in CompressedStreamingUGUITexture data, StreamingUGUITexture texture) {
            ...
            texture.Path = bank.ReadString(data.PathIdx);
        }
    }
    ...
    public struct CompressedImage {
        ...
        static public void Compress(CompressedPackageBuilder compressor, Image image, out CompressedImage data) {
        ...
        static public void Decompress(CompressedPackageBank bank, in CompressedImage data, Image image, CompressedPackageAssetCache cache) {
            CompressedGraphic.Decompress(data.Graphic, image);
            image.sprite = bank.ReadAsset<Sprite>(data.SpriteIdx, cache);
    ...
    public struct CompressedTextMeshPro {
        ...
        static public void Compress(CompressedPackageBuilder compressor, TMP_Text text, out CompressedTextMeshPro data) {
        ...
        static public void Decompress(CompressedPackageBank bank, in CompressedTextMeshPro data, TMP_Text text, CompressedPackageAssetCache cache) {
            CompressedGraphic.Decompress(data.Graphic, text);

            text.font = bank.ReadAsset<TMP_FontAsset>(data.FontIdx, cache);
            ...
            text.text = bank.ReadString(data.TextIdx);
